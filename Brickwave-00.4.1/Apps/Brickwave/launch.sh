...
log "APP_START build=00.4.1 mode=live session_store=atomic-file audio=stockos-mplayer mixer=softvol hls_transport=local-vod-spool spool_limit_mib=64 seek=waveform-local waveform=soundcloud-samples ui_playback_fps=30 formats=aac-hls,mp3-hls controls=analog-a-b-dpad"
